...
//	public static void main(String[] args) throws ClassNotFoundException {
	...
	// 직접 처리하지 않고 호출한 쪽으서 다양한 방식으로 처리할 수 있도록 예외 떠넘기기
	public static void findClass() throws ClassNotFoundException {  //ClassNotFoundExceptiond 예외가 발생하면 떠넘기겠다 (,로 예외 추가 가능)
