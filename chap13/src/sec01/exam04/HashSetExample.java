...
public class HashSetExample {
	...
	public static void main(String[] args) {
		// Set 특징
		// 수학의 집합에 비유
		// 순서 없이 데이터를 저장(저장된 요소들을 순서대로 꺼낼 수 없음) (인덱스가 아님)
...
//		Set<String> set = new HashSet<String>();
		Set<String> set = new HashSet();  // 오른쪽 타입 생략하면 왼쪽 Set에 지정된 타입을 따라 감(타입 추론)
...
//			iterator.remove();
		...
		// 이때 2개의 HashSet에 공통적으로 포함됨 데이터는 제거
...
//		System.out.println("교집합: " + class1);
		...
		// 주의 : 3개의 메소드 모두 사용하려면 기준이 되는 HashSet의 데이터 자체를 바꿔버림
		...
		// LinkedHashSet : Set 중에서도 순서를 유지하는 Set
